...
exports.login = catchAsync(async (req, res, next) => {
  ...
  //3) If evenrything is Ok send Token to client
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot your Password? Submit your PATCH requiest with your new password and passwordConfirm to: 
